...
def upgrade() -> None:
    ...
    sa.Column('cover_image', app.common_types.HttpUrlType(length=2083), nullable=True),
    ...
    sa.Column('status', sa.Enum('ACCEPTED', 'PENDING', name='followstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.create_table('gameplatformlink',
    sa.Column('game_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_comment_review_id'), 'comment', ['review_id'], unique=False)
